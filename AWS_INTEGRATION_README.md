# AWS S3 Integration for ArkAngel
...
```toml
# AWS Upload Configuration for ArkAngel
...
When ArkAngel starts, the AWS uploader automatically runs in the background:
...
1. **Start ArkAngel**: The AWS uploader starts automatically
...
2. **Run the app**: Start ArkAngel normally

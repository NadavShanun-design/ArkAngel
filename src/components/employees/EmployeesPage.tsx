                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="text-xs text-muted-foreground font-mono">
                          {data.instances[0]?.detected_keywords
                            ? `Keywords: ${data.instances[0].detected_keywords.slice(0, 3).join(', ')}`
                            : data.instances[0]?.detected_category
                            ? `Category: ${data.instances[0].detected_category}`
                            : 'No metadata'}
                        </div>
                      </div>
                    </div>

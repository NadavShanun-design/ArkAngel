...
export const TauriFileUpload = () => {
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    console.log("[TauriFileUpload] Fallback file upload process...");
    setIsUploading(true);
    ...
    try {
      ...
      console.log("[TauriFileUpload] File read, uploading:", {
        name: file.name,
        size: file.size,
        type: file.type
      });
      ...
      console.log("[TauriFileUpload] Fallback upload completed successfully:", uploadResult);
    } catch (error) {
      console.error("[TauriFileUpload] Fallback upload failed:", error);
      setUploadResult({
        success: false,
